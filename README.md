...
This repository contains the source for my personal website: a simple static site for my research, writing, achievements, and academic profile.

## What the site now includes

- A redesigned landing page with a clearer narrative and direct links into the rest of the site
...
- Shared styling and JavaScript for mobile navigation, filters, theme persistence, and optional math rendering

## Main files

- `index.html` - Homepage
- `about.html` - About / personal and academic positioning
...
- `games.html` - Games and personal interests
- `contact.html` - Contact links and quick access cards
- `casino-game.html`, `prisoner.html`, `two-envelopes.html`, `benfords-law.html`, `sleeping-beauty.html`, `boy-or-girl.html` - Full article pages
- `styles.css` - Shared visual system and layout styling
- `script.js` - Client-side interactivity
- `favicon.svg`, `favicon-32.png`, `apple-touch-icon.png` - Site icon
